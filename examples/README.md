...
- `@ilp/lesson-schema` validates shape, cross-references, safe paths and optional asset manifests. `toStudentLesson()` strips `correctOptionId` before a student payload is produced.
